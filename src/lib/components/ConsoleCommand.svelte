...
<div class="relative flex bg-bg-code-base w-fit">
	<span
		class="top-0 left-0 absolute px-6 md:px-8 py-3 md:py-4 font-mono text-lg md:text-2xl pointer-events-none select-none"
	>
		$
	</span>
	<p class="py-3 md:py-4 pr-6 md:pr-8 pl-12 md:pl-16 outline-0 font-mono text-lg md:text-2xl">
		{command}
	</p>
	<button
		class="bg-bg-button-base px-3 md:px-4 transition hover:-translate-y-2 hover:translate-x-2 active:-translate-y-1 active:translate-x-1 cursor-pointer"
		onclick={() => {
