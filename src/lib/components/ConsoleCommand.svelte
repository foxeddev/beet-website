...
<div class={`relative flex w-fit bg-code-bg ${className}`} {...props}>
	...
	<p class="py-3 pr-6 pl-12 font-mono text-lg md:py-4 md:pr-8 md:pl-16 md:text-2xl">
		{command}
	</p>
	<button
		class="cursor-pointer bg-primary px-3 transition hover:translate-x-2 hover:-translate-y-2 active:translate-x-1 active:-translate-y-1 md:px-4"
		onclick={() => {
